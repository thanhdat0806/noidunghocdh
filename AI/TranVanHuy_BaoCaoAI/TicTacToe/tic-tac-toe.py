...
class TIC_TAC_TOE_AI:
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="TIC TAC TOE", bg="#141414", fg="#00FF00", font=("Lato", 25, "bold")).place(x=110, y=10)
        self.btn_1 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(1), state=DISABLED)
        self.btn_1.place(x=20,y=100)
        self.btn_2 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(2), state=DISABLED)
        self.btn_2.place(x=190,y=100)
        self.btn_3 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(3), state=DISABLED)
        self.btn_3.place(x=360,y=100)

        self.btn_4 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(4), state=DISABLED)
        self.btn_4.place(x=20,y=200)
        self.btn_5 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(5), state=DISABLED)
        self.btn_5.place(x=190,y=200)
        self.btn_6 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(6), state=DISABLED)
        self.btn_6.place(x=360,y=200)

        self.btn_7 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(7), state=DISABLED)
        self.btn_7.place(x=20,y=300)
        self.btn_8 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(8), state=DISABLED)
        self.btn_8.place(x=190,y=300)
        self.btn_9 = Button(self.make_canvas, text="", font=("Arial", 15, "bold", "italic"), width=5, bg="#ffffff", activebackground="#ffffff", bd=3, command=lambda: self.__You_play(9), state=DISABLED)
        ...
        self.AI_first_control = Button(self.make_canvas, text="AI vs YOU", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=lambda: self.control_give("AI_first"))
        self.AI_first_control.place(x=50, y=380)

        self.You_first_control = Button(self.make_canvas, text="YOU vs AI", font=("Arial", 15, "bold", "italic"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=self.control_give)
        self.You_first_control.place(x=290, y=380)
    ...
    def reset(self):# Reset the game
        ...
        for every in self.activate_btn:
            every.config(text="")
        self.AI_first_control['state'] = NORMAL
        self.You_first_control['state'] = NORMAL
    ...
    def control_give(self, indicator="You_first"):# Control give based on You first or computer first play
        self.AI_first_control.config(state=DISABLED, disabledforeground="grey")
        self.You_first_control.config(state=DISABLED, disabledforeground="grey")
        self.reset_btn.config(state=DISABLED, disabledforeground="grey")
        for every in self.activate_btn:
            every.config(state=NORMAL)
        if indicator == "AI_first":
            self.__AI_play()
    ...
    def __AI_play(self):# AI Control
        self.chance_counter+=1
        # For even in self.chance_counter, You first chance..... for odd, computer first chance
        if self.chance_counter == 1:
            self.__sign_insert(9)
            self.AI_cover.append(9)

        elif self.chance_counter == 2:
            You_last = self.You_cover[len(self.You_cover)-1]
            if You_last != 5:
                self.technique = 1
                self.__sign_insert(5)
                self.AI_cover.append(5)
            else:
                self.technique = 2
                self.__sign_insert(9)
                self.AI_cover.append(9)
            ...
            You_input = self.You_cover[len(self.You_cover)-1]
            if You_input%2 == 0:
                self.technique = 1
                ...
                take_prediction = [7,3]
                try:
                    take_prediction.remove(You_input)
                except:    
                    pass
                take_prediction = random.choice(take_prediction)
                self.__sign_insert(take_prediction)
                self.prob.append(1)
                self.AI_cover.append(take_prediction)
            else:
                self.technique = 3
                self.__sign_insert(1)

        elif self.chance_counter == 4:
            You_first = self.You_cover[0]
            You_last = self.You_cover[1]
            opposite = {1:9, 2:8, 3:7, 4:6, 6:4, 7:3, 8:2, 9:1}

            if self.technique == 1:
                take_surr = list(self.surrounding_store[You_first])
                if You_last in take_surr:
                    take_surr.remove(You_last)
                    diff = You_last - You_first

                    if diff == 6 or diff == -6:
                        if diff == 6:
                            place_it = You_first + 3
                        elif diff == -6:
                            place_it = You_first - 3
                    elif diff == 2 or diff == -2:
                        if diff == 2:
                            place_it = You_first + 1
                        else:
                            place_it = You_first - 1
                    elif diff == 1 or diff == -1:
                        if diff == 1:
                            if You_first-1 == 1 or You_first-1 == 7:
                                place_it = You_first-1
                            else:
                                place_it = You_last+1
                        else:
                            if You_last-1 == 1 or You_last-1 == 7:
                                place_it = You_last-1
                            else:
                                place_it = You_first+1
                    elif diff == 3 or diff == -3:
                        if diff == 3:
                            if You_first-3 == 1 or You_first-3 == 3:
                                place_it = You_first-3
                            else:
                                place_it = You_last+3
                        else:
                            if You_last-3 == 1 or You_last-3 == 3:
                                place_it = You_last-3
                            else:
                                place_it = You_first+3

                    self.__sign_insert(place_it)
                    self.AI_cover.append(place_it)
                    self.prob.append(opposite[place_it])
                    self.surrounding_store[You_first] = tuple(take_surr)
                else:
                    if 2 not in self.sign_store.keys():
                        self.__sign_insert(2)
                        self.AI_cover.append(2)
                        if opposite[2] not in self.sign_store.keys():
                            self.prob.append(opposite[2])
                    else:
                        temp = [4,6,8]
                        take_total = self.You_cover+self.AI_cover
                        for x in take_total:
                            if x in temp:
                                temp.remove(x)
                        take_choice = random.choice(temp)
                        self.__sign_insert(take_choice)
                        self.AI_cover.append(take_choice)
                ...
                self.AI_cover.append(take_place)

        elif self.chance_counter == 5:
            You_input = self.You_cover[len(self.You_cover)-1]
            if self.technique == 1:
                if self.prob[0] != You_input:
                    ...
                    if self.technique == 1:
                        ...
                        self.AI_cover.append(value_take)
                
            elif self.technique == 2:
                    if self.AI_cover[0] - self.AI_cover[1] == 6:
                        try:
                            if self.sign_store[self.AI_cover[1]+3] == "O":
                                self.prob.clear()
                                ...
                                self.AI_cover.append(value_predict)
                        except:
                            self.__sign_insert(self.AI_cover[1]+3)  
                            self.AI_line_match()
                    else:
                        try:
                            if self.sign_store[self.AI_cover[1]+1] == "O":
                                self.prob.clear()
                            ...
                            self.__sign_insert(self.AI_cover[1]+1)  
                            self.AI_cover.append(self.AI_cover[1]+1)
                            self.AI_line_match()
            else:
                if self.prob:
                    self.prob.clear()
                draw_occurance =  {2: 8, 8: 2, 4: 6, 6: 4}
                if You_input in draw_occurance.keys():
                    self.technique = 3.1
                    self.__sign_insert(draw_occurance[You_input])  
                    self.AI_cover.append(draw_occurance[You_input])
                    next_prob = {8: 7, 4: 7, 2: 3, 6: 3}
                    self.prob.append(next_prob[draw_occurance[You_input]])
                else:
                    self.technique = 3.2
                    if You_input == 3:
                        self.__sign_insert(7)  
                        self.AI_cover.append(7)
                        self.prob.append(8)
                        self.prob.append(4)
                    else:
                        self.__sign_insert(3)  
                        self.AI_cover.append(3)
                        self.prob.append(2)
                        self.prob.append(6)
                    
        elif self.chance_counter == 6:
            if self.You_line_match():
                opposite = {1:9, 2:8, 3:7, 4:6, 6:4, 7:3, 8:2, 9:1}
                You_last = self.You_cover[len(self.You_cover)-1]
                if self.technique == 1:
                    if self.prob and You_last != self.prob[0]:
                        self.__sign_insert(self.prob[0])
                        self.AI_cover.append(self.prob[0])
                        self.AI_line_match()
                    
                    elif len(self.prob) == 0:
                        if You_last+3 == 7 or You_last+3 == 9:
                            take_place = You_last+3
                        elif You_last-3 == 1 or You_last-3 == 3:
                            take_place = You_last-3
                        elif You_last-3 == 4 or You_last-3 == 6:
                            take_place = You_last-3
                        elif You_last+3 == 4 or You_last+3 == 6:
                            take_place = You_last+3
                        ...
                        if You_last%2 == 0:
                            if You_last == 8:
                                if (You_last+1==3 or You_last+1==9) and You_last + 1 not in self.sign_store.keys():
                                    place_here = You_last + 1
                                elif (You_last-1==1 or You_last-1==7) and You_last - 1 not in self.sign_store.keys(): 
                                    place_here = You_last - 1
                                elif (You_last-3==1 or You_last-3==3) and You_last - 3 not in self.sign_store.keys(): 
                                    place_here = You_last - 3
                                else:
                                    place_here = You_last + 3
                                
                                self.__sign_insert(place_here)
                                self.AI_cover.append(place_here)
                                temp_oppo = {7: 3, 3: 7, 1: 9, 9: 1}
                                self.prob.append(temp_oppo[place_here])

                            else:
                                take_center_surr = list(self.surrounding_store[5])
                                temp_store = self.You_cover+self.AI_cover
                                ...
                                if take_center_surr:
                                    if (You_last+3==7 or You_last+3==9) or You_last+3 in self.sign_store.keys():
                                        take_place = You_last-3
                                    else:
                    ...
                    if len(self.prob) == 2:
                        if You_last in self.prob:
                            
                            if self.prob[1] != You_last:
                                self.__sign_insert(self.prob[1])
                                self.AI_cover.append(self.prob[1])
                                self.AI_line_match()
                        ...
                        if You_last != self.prob[0]:
                            self.__sign_insert(self.prob[0])
                            self.AI_cover.append(self.prob[0])
                            self.AI_line_match()
                        else:
                            self.__sign_insert(opposite[self.prob[0]])
                            self.AI_cover.append(opposite[self.prob[0]])
            ...
            if self.technique == 1:
                ...
                if You_input in self.prob:
                    self.prob.remove(You_input) 
                self.__sign_insert(self.prob[0])  
                self.AI_line_match()
            else:
                if self.technique == 3.2:
                    ...
                    if You_input in self.prob:
                        self.prob.clear()
                        AI_next_chance = {7: 3, 3: 7}
                        self.__sign_insert(AI_next_chance[You_input])
                        next_You_prob = {3: (2,6), 7: (4,8)}
                        self.prob.append(next_You_prob[AI_next_chance[You_input]][0])
                        self.prob.append(next_You_prob[AI_next_chance[You_input]][1])
                    else:
                        self.__sign_insert(self.prob[0])
                        self.AI_line_match()
            ...
            if self.You_line_match():
                ...
                if self.technique == 1:
                    if self.prob and You_last not in self.prob:
                        if self.prob[0] not in self.sign_store.keys():
                            self.__sign_insert(self.prob[0])
                            self.AI_cover.append(self.prob[0])
                        else:
                            temp=[1,2,3,4,5,6,7,8,9]
                            temp_store = self.AI_cover + self.You_cover
                            for x in temp_store:
                                if x in temp:
                                    temp.remove(x)
                            take_choice = random.choice(temp)
                        ...
                        self.__sign_insert(You_last+2)
                        self.AI_cover.append(You_last+2)

                    else:
                        if len(self.prob) == 2:
                            if You_last in self.prob:
                                self.prob.remove(You_last)
                            self.__sign_insert(self.prob[0])
                            self.AI_cover.append(self.prob[0])
                            self.AI_line_match()
                    ...
                    if opposite[You_last] not in self.sign_store.keys():
                        self.__sign_insert(opposite[You_last])
                        self.AI_cover.append(opposite[You_last])
                    else:
                        temp_store = [1,2,3,4,5,6,7,8,9]
                        temp_total = self.AI_cover+self.You_cover
                        for element in temp_store:
            ...
            if self.prob[0] in self.sign_store.keys() and self.prob[1] in self.sign_store.keys():
                ...
                self.__sign_insert(opposite_detection[You_input])
                self.AI_line_match()
            else:
    ...
    def __You_play(self, chance):# You Control
        self.chance_counter+=1
        self.__sign_insert(chance, "O")
        self.You_cover.append(chance)
        if self.chance_counter == 9:
            self.You_line_match()
        else:    
            self.__AI_play()
    
    def AI_line_match(self):
        found = 0
